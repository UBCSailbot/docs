...
There are two launch processes that we utilize: namely the Global Launch Process and the Package Launch Process.

!!! tip "Interacting with the diagram"

    - To switch between the global process and package launch process diagrams, hover over the image to make
      the toolbar visible and navigate with the arrows on the left side
...
<iframe frameborder="0" style="width:100%;height:600px;" src="https://viewer.diagrams.net/?highlight=0000ff&nav=1&title=Launch_File_Architecture.drawio#Uhttps%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D1B5ayOHnFcVvFmLeAGr6nOryFvVqk5abI%26export%3Ddownload"></iframe>
...
must be provided. This is not always the case when a launch file is contained within a ROS package. This
